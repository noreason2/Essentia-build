...
:doit
if /i "%1#" == "--libs#"    echo -L/home/randall/Downloads/essentia-2.1_beta2/packaging/win32_3rdparty/lib -llibtag
if /i "%1#" == "--cflags#"  echo -I/home/randall/Downloads/essentia-2.1_beta2/packaging/win32_3rdparty/include/taglib
if /i "%1#" == "--version#" echo 1.9.1
if /i "%1#" == "--prefix#"  echo /home/randall/Downloads/essentia-2.1_beta2/packaging/win32_3rdparty
